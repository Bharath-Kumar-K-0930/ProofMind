...
const Hyperspeed = ({
    effectOptions = {
        ...
        colors: {
            ...
            background: 0x000000,
            shoulderLines: 0x74f0ed, // Primary Teal
            brokenLines: 0x74f0ed,    // Primary Teal
            leftCars: [0xff0050, 0xd40043, 0xa30033], // Secondary Red/Pink
            rightCars: [0x74f0ed, 0x5cdbd8, 0x4bc2c0], // Primary Teal
            sticks: 0x74f0ed // Primary Teal
        }
    }
}) => {
